            ...
            <div className='w3-main' style='margin-left:300px'>
                ...
                <div className='w3-row-padding'>
                    <div className='w3-third w3-container w3-margin-bottom'>
                        <img src='./base_arquivos/mountains.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                    ...
                    <div className='w3-third w3-container w3-margin-bottom'>
                        <img src='./base_arquivos/lights.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                        <div className='w3-container w3-white'>
                            <p><b>Lorem Ipsum</b></p>
                            <p>Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue
                                gravida diam non fringilla.</p>
                    ...
                    <div className='w3-third w3-container'>
                        <img src='./base_arquivos/nature.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                        <div className='w3-container w3-white'>
                            <p><b>Lorem Ipsum</b></p>
                            <p>Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue
                                gravida diam non fringilla.</p>
                ...
                <div className='w3-row-padding'>
                    <div className='w3-third w3-container w3-margin-bottom'>
                        <img src='./base_arquivos/p1.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                        <div className='w3-container w3-white'>
                            <p><b>Lorem Ipsum</b></p>
                            <p>Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue
                                gravida diam non fringilla.</p>
                    ...
                    <div className='w3-third w3-container w3-margin-bottom'>
                        <img src='./base_arquivos/p2.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                        <div className='w3-container w3-white'>
                            <p><b>Lorem Ipsum</b></p>
                            <p>Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue
                                gravida diam non fringilla.</p>
                    ...
                    <div className='w3-third w3-container'>
                        <img src='./base_arquivos/p3.jpg' alt='Norway' style='width:100%' className='w3-hover-opacity' />
                        <div className='w3-container w3-white'>
                            <p><b>Lorem Ipsum</b></p>
                            <p>Praesent tincidunt sed tellus ut rutrum. Sed vitae justo condimentum, porta lectus vitae, ultricies congue
                                gravida diam non fringilla.</p>
